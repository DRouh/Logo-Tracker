...
for f in glob.glob('rootsift (all descs)/*.rsift'):
    target = 1 if 'cocacola' in f else 2 if 'pepsi' in f else 0
...
counter = 1
n_clusters = 300
estimator = pickle.load(open('KMeansColaPepsiAndNoneRootSIFT.pkl', "rb"))
